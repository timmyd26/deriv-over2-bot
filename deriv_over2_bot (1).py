...
RULES = [
    {"digit": 0, "min": 8.1, "max": 9.7},
    {"digit": 1, "min": 8.1, "max": 9.7},
...
async def main():
    send_telegram(
        ...
        "Watching: All 10 Volatility markets (standard + 1s)\n"
        "Digit 0 and 1: 8.1%–9.7% | Digit 2: 10%–11%\n"
        "Min ticks: 25 | You will be notified when signal fires."
    )
